#!/usr/bin/env node
// Taken from https://github.com/babel/babel/blob/7.0/packages/babel-cli/src/_babel-node.js
//   and added `--config` option
/* eslint-disable */
...
program.option("-c, --config [filepath]", ".babelrc file to load as config");
